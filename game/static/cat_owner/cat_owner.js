...
canvas.height = 450;
var floor = new Image();
floor.src = "/static/cat_owner/co_assets/img/floor.png";
...
var Bowl = /** @class */ (function () {
    function Bowl() {
        ...
        this.imageBasePath = "/static/cat_owner/co_assets/img/bowl"; // Base path for images
    ...
    Cat.prototype.loadImages = function () {
        ...
        states.forEach(function (state) {
            ...
            for (var i = 1; i <= 2; i++) { // Assuming 2 frames per state
                var img = new Image();
                img.src = "/static/cat_owner/co_assets/img/".concat(_this.color).concat(state).concat(i, ".png");
